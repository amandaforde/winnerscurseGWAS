## WINNER'S CURSE SIMULATION STUDY SCRIPT 5 - EVALUATING METHODS (IND1):
...
## The simulated data sets also correspond to a quantitative trait with a normal
...
## Outputs: 
## 1. norm_5e-8_100sim_ave.csv
## 2. norm_5e-8_100sim_all.csv
## 3. norm_5e-4_100sim_ave.csv
## 4. norm_5e-4_100sim_all.csv
...
write.csv(results_all,"simulations/results/norm_5e-8_100sim_ave.csv")
...
write.csv(results_all,"simulations/results/norm_5e-8_100sim_all.csv")
...
run_sim <- function(n_samples, h2, prop_effect, S,sim)
{
  ...
  rel_mse_EB <- rmse_sig_improve_per(out_EB,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_EB_df <- rmse_sig_improve_per(out_EB_df,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_EB_scam <- rmse_sig_improve_per(out_EB_scam,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_EB_gam_po <- rmse_sig_improve_per(out_EB_gam_po,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_EB_gam_nb <- rmse_sig_improve_per(out_EB_gam_nb,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_FIQT <- rmse_sig_improve_per(out_FIQT,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_BR <- rmse_sig_improve_per(out_BR,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_cl1 <- rmse_sig_improve_per(out_cl,ss$true_beta,i=4,alpha=5e-4)
  ...
  rel_mse_cl2 <- rmse_sig_improve_per(out_cl,ss$true_beta,alpha=5e-4,i=5)
  ...
  rel_mse_cl3 <- rmse_sig_improve_per(out_cl,ss$true_beta,alpha=5e-4,i=6)
  ...
  rel_mse_rep <- rmse_sig_improve_per(out_rep,ss$true_beta,i=4,alpha=5e-4)
...
results_all <- rbind(ave_res_EB,ave_res_EB_df,ave_res_EB_scam,ave_res_EB_gam_po,ave_res_EB_gam_nb,ave_res_FIQT,ave_res_BR,ave_res_cl1,ave_res_cl2,ave_res_cl3, ave_res_rep, ave_res_naive)
results_all$method <- c(rep("EB",(nrow(sim_params)/tot_sim)),rep("EB_df",(nrow(sim_params)/tot_sim)),rep("EB_scam",(nrow(sim_params)/tot_sim)),rep("EB_gam_po",(nrow(sim_params)/tot_sim)),rep("EB_gam_nb",(nrow(sim_params)/tot_sim)),rep("FIQT",(nrow(sim_params)/tot_sim)),rep("BR",(nrow(sim_params)/tot_sim)),rep("cl1",(nrow(sim_params)/tot_sim)),rep("cl2",(nrow(sim_params)/tot_sim)),rep("cl3",(nrow(sim_params)/tot_sim)), rep("rep",(nrow(sim_params)/tot_sim)),rep("naive",(nrow(sim_params)/tot_sim)))
write.csv(results_all,"simulations/results/norm_5e-4_100sim_ave.csv")

## Combine all results:
results_all <- rbind(res_EB,res_EB_df,res_EB_scam,res_EB_gam_po,res_EB_gam_nb,res_FIQT,res_BR,res_cl1,res_cl2,res_cl3,res_rep,res_naive)
results_all$method <- c(rep("EB",nrow(sim_params)),rep("EB_df",nrow(sim_params)),rep("EB_scam",nrow(sim_params)),rep("EB_gam_po",nrow(sim_params)),rep("EB_gam_nb",nrow(sim_params)),rep("FIQT",nrow(sim_params)),rep("BR",nrow(sim_params)),rep("cl1",nrow(sim_params)),rep("cl2",nrow(sim_params)),rep("cl3",nrow(sim_params)),rep("rep",nrow(sim_params)),rep("naive",nrow(sim_params)))
write.csv(results_all,"simulations/results/norm_5e-4_100sim_all.csv")
